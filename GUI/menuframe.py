...
class MenuFrame(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        Button(sorting,
               ...
               bg=button_color,
               command=lambda i=0: parent.set_running_algorithm(bubbleSort.BubbleSort)
               ).grid(row=0, column=0)
        Button(sorting,
               text='Insertion Sort',
               relief='flat',
               font='helvetica 15 bold',
               bg=button_color,
               command=lambda i=0: parent.set_running_algorithm(insertionSort.InsertionSort)
               ).grid(row=0, column=1)
        Button(sorting,
               text='Selection Sort',
               relief='flat',
               font='helvetica 15 bold',
               bg=button_color,
               command=lambda i=0: parent.set_running_algorithm(selectionSort.SelectionSort)
               ).grid(row=0, column=2)
        Button(sorting,
               text='Merge Sort',
               relief='flat',
               font='helvetica 15 bold',
               bg=button_color,
               command=lambda i=0: parent.set_running_algorithm(mergeSort.MergeSort)
               ).grid(row=1, column=0)
        Button(sorting,
               text='Quick Sort',
               relief='flat',
               font='helvetica 15 bold',
               bg=button_color,
               command=lambda i=0: parent.set_running_algorithm(quickSort.QuickSort)
               ).grid(row=1, column=1)
        Button(sorting,
               text='Counting Sort',
               relief='flat',
        ...
        Button(searching,
               ...
               font='helvetica 15 bold',
               bg=button_color,
               command=None  # parent.set_running_algorithm(PathFinder)
               ).grid(row=0, column=0)
